...
<div class="header-image-container">
    <div class="left-header-img display-none-in-mobile">
        <img style="margin-top: 100px;" src="<?php bloginfo('template_directory'); ?>/images/header-right.png" />
    </div>
    <div class="right-header-img">
        <img class="display-none-in-mobile" src="<?php bloginfo('template_directory'); ?>/images/sag-dovom.png" />
        <img class="display-none-in-desktop" src="<?php bloginfo('template_directory'); ?>/images/sag-dovom-mobile.png" />
    </div>
</div>
...
<div class="header-image-container">
    <div class="left-header-img">
        <img class="display-none-in-mobile" src="<?php bloginfo('template_directory'); ?>/images/header-paein.png" />
        <img class="display-none-in-desktop" src="<?php bloginfo('template_directory'); ?>/images/header-paein-mobile.png" />
    </div>
    <div class="right-header-img display-none-in-mobile">
...
<footer class="compact-footer">
    ...
    <div class="footer-layer1">
        <div class="footer-left">
            <div class="burger-button-footer change" onclick="compactFooter(this)">
            ...
            <div class="social-holder-bottom">
                <div class="owl-carousel social-icons">
                    <div class="footer-carousel-item">
                        <a href="tel:+989126189863"><img src="<?php bloginfo('template_directory'); ?>/images/phone.png" />
                            <span>خط 1</span>
                        </a>
                    </div>
                    <div class="footer-carousel-item">
                    ...
                    <div class="footer-carousel-item">
                        <a href="https://t.me/USERNAME"><img src="<?php bloginfo('template_directory'); ?>/images/telegram.png" />
                            <span>تلگرام 1</span>
                        </a>
                    </div>
                    <div class="footer-carousel-item">
                    ...
                    <div class="footer-carousel-item">
                        <a href="whatsapp://send?abid=989126189863&text=Hello%2C%20World!"><img src="<?php bloginfo('template_directory'); ?>/images/whatsapp.png" />
                            <span>واتساپ 1</span>
                        </a>
                    </div>
                    <div class="footer-carousel-item">
                    ...
                    <div class="footer-carousel-item">
                        <a href="https://instagram.com/username"><img src="<?php bloginfo('template_directory'); ?>/images/instagram.png" />
